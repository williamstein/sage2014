︠e6e4eb04-4353-46fe-babb-c214ff3d1613i︠
%md
Screencast in which I used this <http://youtu.be/PQcBuoT2PiI>
︡e098f952-0fde-4d07-8107-b2bccaf39925︡{"html":"<p>Screencast in which I used this <a href=\"http://youtu.be/PQcBuoT2PiI\">http://youtu.be/PQcBuoT2PiI</a></p>\n"}︡
...
This is a programming problem that is nice and easy to get us started with programming in Python.
  ...
  - write a Python function that takes as input 3 arguments, and returns their sum, product, and average.  It should have a docstring.
...
︡11caaa3b-9741-4223-bb19-f6c0761a15be︡{"html":"<h2>Problem 2</h2>\n\n<p>This is a programming problem that is nice and easy to get us started with programming in Python.</p>\n\n<ul>\n<li><p>write a Python function that takes as input 3 arguments, and returns their sum, product, and average.  It should have a docstring.</p></li>\n<li><p>write a function <code>fibonacci_list</code> that takes an integer n as input, and returns a list containing the first n Fibonacci numbers.</p></li>\n</ul>\n"}︡
︠fb884569-fbda-4a3b-8114-c894bd38abf4︠
prod??
︠e805e8d9-044a-42b1-b848-c8f00e5af855︠
def prob_2(x,y,z):
    """
    It takes as input 3 arguments, and returns their sum, product, and average; it has a docstring.
    ...
    """
    # do the hard part
    return sum([x,y,z]), prod([x,y,z]), mean([x,y,z])

︡4d4307b1-4938-4c53-84f9-373ca141fbea︡
︠fec69814-5ffd-44dc-9e64-bc44bd8df727︠
prob_2(1,2,3)
︡47e98ed7-743a-401e-b1ac-7d1828412e20︡{"stdout":"(6, 6, 2)\n"}︡
︠7eb3f238-d006-4209-bc10-324401d7d6dd︠
prob_2(389,37,11)


︡aaec9b4c-d56e-46a3-a302-ef89f556bb2e︡{"stdout":"(437, 158323, 437/3)\n"}︡
︠665a7c9f-b0d3-4d90-9324-ac3c498a1896︠
45, 17, 'hello'

︡3f2ebed9-87b2-4784-8cb4-26cd36bc9ee7︡{"stdout":"(45, 17, 'hello')\n"}︡
